    ...
    if (has('/help', 'ayuda', 'comandos')) {
      return {
        ...
        text: [
          ...
          '  exportar [anonimizado]             → descarga JSON con paciente + episodios + dx + imágenes',
          ...
          '',
          '**Telemedicina** (red de derivación primario → turno → especialistas)',
          ...
          '  ver chatter                        → muestra feed de actividad',
          '',
          '**Recordatorios**',
